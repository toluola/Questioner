...
// 				expect(res.body.meetups).to.have.property("id");
// 				expect(res.body.meetups).to.have.property("created_on");
// 				expect(res.body.meetups).to.have.property("location");
// 				expect(res.body.meetups).to.have.property("images");
// 				expect(res.body.meetups).to.have.property("topic");
// 				expect(res.body.meetups).to.have.property("happening_on");
// 				expect(res.body.meetups).to.have.property("tags");
// 				expect(res.body)
// 					.to.have.property("message")
